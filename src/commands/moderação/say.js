...
module.exports = class extends Command {
    ...
    run = async (interaction) => {
        if (!interaction.member.permissions.has('MANAGE_MESSAGES')) return interaction.reply({ content: 'Você não tem permissão para usar este comando!', ephemeral: false })
        ...
        if (!channels.size) return interaction.reply({ content: 'Não consigo enviar a mensagem em nenhum dos canais do servidor.', ephemeral: false })

        const actionRow = new MessageActionRow()
            .addComponents([
                new MessageSelectMenu()
                    .setCustomId('channelSelect')
                    .setPlaceholder('Selecione um canal que')
                    .addOptions(
                        channels
                            .map(c => {
                                return {
        ...
        collector.on('collect', (i) => {
            ...
            const embed = new MessageEmbed()
                ...
                .setColor('#00ff00')
                .setThumbnail('https://cdn.discordapp.com/icons/905943252895678485/8b75f8e3170fcdf20fc9b6f7354125de.png')
                .setTimestamp()
                .setFooter('BossBot © Todos os direitos reservados.', 'https://cdn.discordapp.com/icons/905943252895678485/8b75f8e3170fcdf20fc9b6f7354125de.png')
